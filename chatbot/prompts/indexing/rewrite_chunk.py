...
---
## GOAL
Your task is to rewrite the provided Vietnamese text chunk, ensuring that it aligns with and enhances the summarized context extracted from the full document. The final output must be in Vietnamese and limited to maximum {max_tokens} tokens.

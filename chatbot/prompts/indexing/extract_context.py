...
---------------------
-GOAL-
Your task is to extract the main context from the provided Vietnamese text about Trường Đại học Bách Khoa TP.HCM (Ho Chi Minh City University of Technology). You should produce a detailed summary and a list of topics that cover all significant aspects of the document. The final output must be entirely in **Vietnamese**.
